...
Partial Class Administration_SeriousnessCriterion
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Seriousness Criterion"
                    EditSeriousnessCriterion_Button.Visible = True
                    DeleteSeriousnessCriterion_Button.Visible = False
                    SaveSeriousnessCriterionUpdate_Button.Visible = False
                    ConfirmSeriousnessCriterionDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM SeriousnessCriteria WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditSeriousnessCriterion_Button.Visible = False
                    DeleteSeriousnessCriterion_Button.Visible = False
                    SaveSeriousnessCriterionUpdate_Button.Visible = False
                    ConfirmSeriousnessCriterionDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/SeriousnessCriterion.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditSeriousnessCriterion_Button_Click(sender As Object, e As EventArgs) Handles EditSeriousnessCriterion_Button.Click
        Title_Label.Text = "Edit Seriousness Criterion"
        EditSeriousnessCriterion_Button.Visible = False
        DeleteSeriousnessCriterion_Button.Visible = False
        SaveSeriousnessCriterionUpdate_Button.Visible = True
        ConfirmSeriousnessCriterionDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a seriousness criterion name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteSeriousnessCriterion_Button_Click(sender As Object, e As EventArgs) Handles DeleteSeriousnessCriterion_Button.Click
        Title_Label.Text = "Permanently Delete Seriousness Criterion"
        EditSeriousnessCriterion_Button.Visible = False
        DeleteSeriousnessCriterion_Button.Visible = False
        SaveSeriousnessCriterionUpdate_Button.Visible = False
        ConfirmSeriousnessCriterionDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this seriousness criterion"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM SeriousnessCriteria WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The seriousness criterion name you have entered is already taken. Please choose a different seriousness criterion name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid seriousness criterion name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM SeriousnessCriteria WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveSeriousnessCriterionUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveSeriousnessCriterionUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE SeriousnessCriteria SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmSeriousnessCriterionDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmSeriousnessCriterionDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Seriousness Criterion"
        EditSeriousnessCriterion_Button.Visible = False
        DeleteSeriousnessCriterion_Button.Visible = False
        SaveSeriousnessCriterionUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM SeriousnessCriteria WHERE ID = @ID", Connection)
