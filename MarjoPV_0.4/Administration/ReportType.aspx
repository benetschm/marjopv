<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="ReportType.aspx.vb" Inherits="Administration_ReportType" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditReportType_Button" runat="server" class="btn btn-primary" Text="Edit Report Type"></asp:button>
                <asp:button ID="DeleteReportType_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Report Type"></asp:button>
                <asp:button ID="SaveReportTypeUpdate_Button" runat="server" class="btn btn-primary" Text="Save Report Type Updates"></asp:button>
                <asp:button ID="ConfirmReportTypeDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Report Type Deletion"></asp:button>
