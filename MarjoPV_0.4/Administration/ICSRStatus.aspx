<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="ICSRStatus.aspx.vb" Inherits="Administration_ICSRStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="Buttons" class="panel btn-group" runat="server">
                <asp:button ID="SaveUpdates_Button" runat="server" class="btn btn-primary" Text="Save ICSR Status Updates"></asp:button>
                ...
                <table class="table table-responsive table-striped table-hover">
                    ...
                    <tr id="IsStatusNew_Row" runat="server">
                        ...
                        <td>
                            ...
                            <asp:CustomValidator ID="IsStatusNew_CustomValidator" runat="server" OnServerValidate="IsStatusNew_DropDownList_Validator_ServerValidate"></asp:CustomValidator>
                        </td>
                    </tr>
    ...
    <asp:HiddenField ID="AtEditPageLoad_ICSRStatusID_HiddenField" runat="server" />
</asp:Content>
