<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="DechallengeResult.aspx.vb" Inherits="Administration_DechallengeResult" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditDechallengeResult_Button" runat="server" class="btn btn-primary" Text="Edit Dechallenge Result"></asp:button>
                <asp:button ID="DeleteDechallengeResult_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Dechallenge Result"></asp:button>
                <asp:button ID="SaveDechallengeResultUpdate_Button" runat="server" class="btn btn-primary" Text="Save Dechallenge Result Updates"></asp:button>
                <asp:button ID="ConfirmDechallengeResultDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Dechallenge Result Deletion"></asp:button>
