<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="Outcome.aspx.vb" Inherits="Administration_Outcome" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditOutcome_Button" runat="server" class="btn btn-primary" Text="Edit Outcome"></asp:button>
                <asp:button ID="DeleteOutcome_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Outcome"></asp:button>
                <asp:button ID="SaveOutcomeUpdate_Button" runat="server" class="btn btn-primary" Text="Save Outcome Updates"></asp:button>
                <asp:button ID="ConfirmOutcomeDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Outcome Deletion"></asp:button>
