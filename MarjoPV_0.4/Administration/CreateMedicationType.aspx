<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateMedicationType.aspx.vb" Inherits="Administration_CreateMedicationType" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewMedicationType_Button" runat="server" class="btn btn-primary" Text="Save New Medication Type"></asp:button>
