...
Partial Class Administration_CreateRelatednessCriterionReporter
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "Create New Relatedness Criterion Reporter"
                    SaveNewRelatednessCriterionReporter_Button.Visible = True
                ...
                Else
                    ...
                    SaveNewRelatednessCriterionReporter_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/CreateRelatednessCriterionReporter.aspx")
            End If
        End If
    End Sub
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        'Check if entered relatedness criterion reporter name is already taken and fail validation if not
        Dim Command As New SqlCommand("SELECT Name FROM RelatednessCriteriaReporter", Connection)
        ...
        End While
        Connection.Close()
        'Check if relatedness criterion reporter name was entered and fail validation if not
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM RelatednessCriteriaReporter", Connection)
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveNewRelatednessCriterionReporter_Button_Click(sender As Object, e As EventArgs) Handles SaveNewRelatednessCriterionReporter_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim Command As New SqlCommand("INSERT INTO RelatednessCriteriaReporter(Name, SortOrder, Active) VALUES(@Name, @SortOrder, @Active)", Connection)
