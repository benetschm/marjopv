...
Partial Class Administration_RechallengeResult
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Rechallenge Result"
                    EditRechallengeResult_Button.Visible = True
                    DeleteRechallengeResult_Button.Visible = False
                    SaveRechallengeResultUpdate_Button.Visible = False
                    ConfirmRechallengeResultDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM RechallengeResults WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditRechallengeResult_Button.Visible = False
                    DeleteRechallengeResult_Button.Visible = False
                    SaveRechallengeResultUpdate_Button.Visible = False
                    ConfirmRechallengeResultDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/RechallengeResult.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditRechallengeResult_Button_Click(sender As Object, e As EventArgs) Handles EditRechallengeResult_Button.Click
        Title_Label.Text = "Edit Rechallenge Result"
        EditRechallengeResult_Button.Visible = False
        DeleteRechallengeResult_Button.Visible = False
        SaveRechallengeResultUpdate_Button.Visible = True
        ConfirmRechallengeResultDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a rechallenge result name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteRechallengeResult_Button_Click(sender As Object, e As EventArgs) Handles DeleteRechallengeResult_Button.Click
        Title_Label.Text = "Permanently Delete Rechallenge Result"
        EditRechallengeResult_Button.Visible = False
        DeleteRechallengeResult_Button.Visible = False
        SaveRechallengeResultUpdate_Button.Visible = False
        ConfirmRechallengeResultDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this rechallenge result"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        'Check if entered rechallenge result name is already taken and fail validation if not
        Dim Command As New SqlCommand("SELECT Name FROM RechallengeResults WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The rechallenge result name you have entered is already taken. Please choose a different rechallenge result name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        End While
        Connection.Close()
        'Check if rechallenge result name was entered and fail validation if not
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid rechallenge result name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM RechallengeResults WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveRechallengeResultUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveRechallengeResultUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE RechallengeResults SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmRechallengeResultDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmRechallengeResultDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Rechallenge Result"
        EditRechallengeResult_Button.Visible = False
        DeleteRechallengeResult_Button.Visible = False
        SaveRechallengeResultUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM RechallengeResults WHERE ID = @ID", Connection)
