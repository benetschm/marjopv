...
Partial Class Administration_Outcome
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Outcome"
                    EditOutcome_Button.Visible = True
                    DeleteOutcome_Button.Visible = False
                    SaveOutcomeUpdate_Button.Visible = False
                    ConfirmOutcomeDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM Outcomes WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditOutcome_Button.Visible = False
                    DeleteOutcome_Button.Visible = False
                    SaveOutcomeUpdate_Button.Visible = False
                    ConfirmOutcomeDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/Outcome.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditOutcome_Button_Click(sender As Object, e As EventArgs) Handles EditOutcome_Button.Click
        Title_Label.Text = "Edit Outcome"
        EditOutcome_Button.Visible = False
        DeleteOutcome_Button.Visible = False
        SaveOutcomeUpdate_Button.Visible = True
        ConfirmOutcomeDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a outcome name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteOutcome_Button_Click(sender As Object, e As EventArgs) Handles DeleteOutcome_Button.Click
        Title_Label.Text = "Permanently Delete Outcome"
        EditOutcome_Button.Visible = False
        DeleteOutcome_Button.Visible = False
        SaveOutcomeUpdate_Button.Visible = False
        ConfirmOutcomeDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this outcome"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM Outcomes WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The outcome name you have entered is already taken. Please choose a different outcome name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid outcome name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM Outcomes WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveOutcomeUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveOutcomeUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE Outcomes SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmOutcomeDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmOutcomeDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Outcome"
        EditOutcome_Button.Visible = False
        SaveOutcomeUpdate_Button.Visible = False
        ConfirmOutcomeDeletion_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM Outcomes WHERE ID = @ID", Connection)
