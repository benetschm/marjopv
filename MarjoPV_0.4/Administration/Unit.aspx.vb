...
Partial Class Administration_Unit
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Unit"
                    EditUnit_Button.Visible = True
                    DeleteUnit_Button.Visible = False
                    SaveUnitUpdate_Button.Visible = False
                    ConfirmUnitDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM Units WHERE ID = @ID", Connection)
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/Unit.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditUnit_Button_Click(sender As Object, e As EventArgs) Handles EditUnit_Button.Click
        Title_Label.Text = "Edit Unit"
        EditUnit_Button.Visible = False
        DeleteUnit_Button.Visible = False
        SaveUnitUpdate_Button.Visible = True
        ConfirmUnitDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a unit name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteUnit_Button_Click(sender As Object, e As EventArgs) Handles DeleteUnit_Button.Click
        Title_Label.Text = "Permanently Delete Unit"
        EditUnit_Button.Visible = False
        DeleteUnit_Button.Visible = False
        SaveUnitUpdate_Button.Visible = False
        ConfirmUnitDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this unit"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM Units WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The unit name you have entered is already taken. Please choose a different unit name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid unit name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM Units WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveUnitUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveUnitUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE Units SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmUnitDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmUnitDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Unit"
        EditUnit_Button.Visible = False
        SaveUnitUpdate_Button.Visible = False
        ConfirmUnitDeletion_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM Units WHERE ID = @ID", Connection)
