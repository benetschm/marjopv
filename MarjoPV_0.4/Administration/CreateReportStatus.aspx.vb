...
Partial Class Administration_CreateReportStatus
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            Title_Label.Text = "Create New Report Status"
            If Login_Status = True Then
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/CreateReportStatus.aspx")
            End If
        End If
    End Sub
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        If TextValidator(Name_Textbox) = True Then 'If valid text was entered
            ...
            Dim Command As New SqlCommand("SELECT Name FROM ReportStatuses", Connection)
    ...
    Protected Sub SaveUpdates_Button_Click(sender As Object, e As EventArgs) Handles SaveUpdates_Button.Click
        If Page.IsValid = True Then
            ...
            Dim Command As New SqlCommand("INSERT INTO ReportStatuses(Name, IsStatusNew, IsStatusClosed, SortOrder, Active) VALUES(@Name, @IsStatusNew, @IsStatusClosed, @SortOrder, @Active)", Connection)
