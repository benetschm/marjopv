...
Partial Class Administration_ExpectednessCriterion
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Expectedness Criterion"
                    EditExpectednessCriterion_Button.Visible = True
                    DeleteExpectednessCriterion_Button.Visible = False
                    SaveExpectednessCriterionUpdate_Button.Visible = False
                    ConfirmExpectednessCriterionDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM ExpectednessCriteria WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditExpectednessCriterion_Button.Visible = False
                    DeleteExpectednessCriterion_Button.Visible = False
                    SaveExpectednessCriterionUpdate_Button.Visible = False
                    ConfirmExpectednessCriterionDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/ExpectednessCriterion.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditExpectednessCriterion_Button_Click(sender As Object, e As EventArgs) Handles EditExpectednessCriterion_Button.Click
        Title_Label.Text = "Edit Expectedness Criterion"
        EditExpectednessCriterion_Button.Visible = False
        DeleteExpectednessCriterion_Button.Visible = False
        SaveExpectednessCriterionUpdate_Button.Visible = True
        ConfirmExpectednessCriterionDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a expectedness criterion name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteExpectednessCriterion_Button_Click(sender As Object, e As EventArgs) Handles DeleteExpectednessCriterion_Button.Click
        Title_Label.Text = "Permanently Delete Expectedness Criterion"
        EditExpectednessCriterion_Button.Visible = False
        DeleteExpectednessCriterion_Button.Visible = False
        SaveExpectednessCriterionUpdate_Button.Visible = False
        ConfirmExpectednessCriterionDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this expectedness criterion"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM ExpectednessCriteria WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The expectedness criterion name you have entered is already taken. Please choose a different expectedness criterion name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid expectedness criterion name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM ExpectednessCriteria WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveExpectednessCriterionUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveExpectednessCriterionUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE ExpectednessCriteria SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmExpectednessCriterionDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmExpectednessCriterionDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Expectedness Criterion"
        EditExpectednessCriterion_Button.Visible = False
        DeleteExpectednessCriterion_Button.Visible = False
        SaveExpectednessCriterionUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM ExpectednessCriteria WHERE ID = @ID", Connection)
