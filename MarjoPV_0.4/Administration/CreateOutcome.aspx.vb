...
Partial Class Administration_CreateOutcome
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "Create New Outcome"
                    SaveNewOutcome_Button.Visible = True
                ...
                Else
                    ...
                    SaveNewOutcome_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/CreateOutcome.aspx")
            End If
        End If
    End Sub
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM Outcomes", Connection)
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM Outcomes", Connection)
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveNewOutcome_Button_Click(sender As Object, e As EventArgs) Handles SaveNewOutcome_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim Command As New SqlCommand("INSERT INTO Outcomes(Name, SortOrder, Active) VALUES(@Name, @SortOrder, @Active)", Connection)
