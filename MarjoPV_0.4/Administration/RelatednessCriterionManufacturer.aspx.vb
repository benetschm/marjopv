...
Partial Class Administration_RelatednessCriterionManufacturer
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Relatedness Criterion Manufacturer"
                    EditRelatednessCriterionManufacturer_Button.Visible = True
                    DeleteRelatednessCriterionManufacturer_Button.Visible = False
                    SaveRelatednessCriterionManufacturerUpdate_Button.Visible = False
                    ConfirmRelatednessCriterionManufacturerDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM RelatednessCriteriaManufacturer WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditRelatednessCriterionManufacturer_Button.Visible = False
                    DeleteRelatednessCriterionManufacturer_Button.Visible = False
                    SaveRelatednessCriterionManufacturerUpdate_Button.Visible = False
                    ConfirmRelatednessCriterionManufacturerDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/RelatednessCriterionManufacturer.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditRelatednessCriterionManufacturer_Button_Click(sender As Object, e As EventArgs) Handles EditRelatednessCriterionManufacturer_Button.Click
        Title_Label.Text = "Edit Relatedness Criterion Manufacturer"
        EditRelatednessCriterionManufacturer_Button.Visible = False
        DeleteRelatednessCriterionManufacturer_Button.Visible = False
        SaveRelatednessCriterionManufacturerUpdate_Button.Visible = True
        ConfirmRelatednessCriterionManufacturerDeletion_Button.Visible = False
    ...
    Protected Sub DeleteRelatednessCriterionManufacturer_Button_Click(sender As Object, e As EventArgs) Handles DeleteRelatednessCriterionManufacturer_Button.Click
        Title_Label.Text = "Permanently Delete Relatedness Criterion Manufacturer"
        EditRelatednessCriterionManufacturer_Button.Visible = False
        DeleteRelatednessCriterionManufacturer_Button.Visible = False
        SaveRelatednessCriterionManufacturerUpdate_Button.Visible = False
        ConfirmRelatednessCriterionManufacturerDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this relatedness criterion manufacturer"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM RelatednessCriteriaManufacturer WHERE ID <> @ID", Connection)
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM RelatednessCriteriaManufacturer WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveRelatednessCriterionManufacturerUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveRelatednessCriterionManufacturerUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE RelatednessCriteriaManufacturer SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmRelatednessCriterionManufacturerDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmRelatednessCriterionManufacturerDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Relatedness Criterion Manufacturer"
        EditRelatednessCriterionManufacturer_Button.Visible = False
        DeleteRelatednessCriterionManufacturer_Button.Visible = False
        SaveRelatednessCriterionManufacturerUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM RelatednessCriteriaManufacturer WHERE ID = @ID", Connection)
