...
Partial Class Administration_DrugAction
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Drug Action"
                    EditDrugAction_Button.Visible = True
                    DeleteDrugAction_Button.Visible = False
                    SaveDrugActionUpdate_Button.Visible = False
                    ConfirmDrugActionDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM DrugActions WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditDrugAction_Button.Visible = False
                    DeleteDrugAction_Button.Visible = False
                    SaveDrugActionUpdate_Button.Visible = False
                    ConfirmDrugActionDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/DrugAction.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditDrugAction_Button_Click(sender As Object, e As EventArgs) Handles EditDrugAction_Button.Click
        Title_Label.Text = "Edit Drug Action"
        EditDrugAction_Button.Visible = False
        DeleteDrugAction_Button.Visible = False
        SaveDrugActionUpdate_Button.Visible = True
        ConfirmDrugActionDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a drug action name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteDrugAction_Button_Click(sender As Object, e As EventArgs) Handles DeleteDrugAction_Button.Click
        Title_Label.Text = "Permanently Delete Drug Action"
        EditDrugAction_Button.Visible = False
        DeleteDrugAction_Button.Visible = False
        SaveDrugActionUpdate_Button.Visible = False
        ConfirmDrugActionDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this drug action"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM DrugActions WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The drug action name you have entered is already taken. Please choose a different drug action name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid drug action name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM DrugActions WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveDrugActionUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveDrugActionUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE DrugActions SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmDrugActionDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmDrugActionDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Drug Action"
        EditDrugAction_Button.Visible = True
        DeleteDrugAction_Button.Visible = False
        SaveDrugActionUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM DrugActions WHERE ID = @ID", Connection)
