<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateReportType.aspx.vb" Inherits="Administration_CreateReportType" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewReportType_Button" runat="server" class="btn btn-primary" Text="Save New Report Type"></asp:button>
