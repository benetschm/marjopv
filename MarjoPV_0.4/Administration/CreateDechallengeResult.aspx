<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateDechallengeResult.aspx.vb" Inherits="Administration_CreateDechallengeResult" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewDechallengeResult_Button" runat="server" class="btn btn-primary" Text="Save New Dechallenge Result"></asp:button>
