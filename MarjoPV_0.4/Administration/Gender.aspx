<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="Gender.aspx.vb" Inherits="Administration_Gender" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditGender_Button" runat="server" class="btn btn-primary" Text="Edit Gender"></asp:button>
                <asp:button ID="DeleteGender_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Gender"></asp:button>
                <asp:button ID="SaveGenderUpdate_Button" runat="server" class="btn btn-primary" Text="Save Gender Updates"></asp:button>
                <asp:button ID="ConfirmGenderDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Gender Deletion"></asp:button>
