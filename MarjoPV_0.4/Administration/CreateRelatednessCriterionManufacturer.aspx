<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateRelatednessCriterionManufacturer.aspx.vb" Inherits="Administration_CreateRelatednessCriterionManufacturer" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewRelatednessCriterionManufacturer_Button" runat="server" class="btn btn-primary" Text="Save New Relatedness Criterion Manufacturer"></asp:button>
