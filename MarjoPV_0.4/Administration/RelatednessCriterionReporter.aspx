<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="RelatednessCriterionReporter.aspx.vb" Inherits="Administration_RelatednessCriterionReporter" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditRelatednessCriterionReporter_Button" runat="server" class="btn btn-primary" Text="Edit Relatedness Criterion Reporter"></asp:button>
                <asp:button ID="DeleteRelatednessCriterionReporter_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Relatedness Criterion Reporter"></asp:button>
                <asp:button ID="SaveRelatednessCriterionReporterUpdate_Button" runat="server" class="btn btn-primary" Text="Save Relatedness Criterion Reporter Updates"></asp:button>
                <asp:button ID="ConfirmRelatednessCriterionReporterDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Relatedness Criterion Reporter Deletion"></asp:button>
