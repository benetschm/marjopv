...
Partial Class Administration_ReportType
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Report Type"
                    EditReportType_Button.Visible = True
                    DeleteReportType_Button.Visible = False
                    SaveReportTypeUpdate_Button.Visible = False
                    ConfirmReportTypeDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM ReportTypes WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditReportType_Button.Visible = False
                    DeleteReportType_Button.Visible = False
                    SaveReportTypeUpdate_Button.Visible = False
                    ConfirmReportTypeDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/ReportType.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditReportType_Button_Click(sender As Object, e As EventArgs) Handles EditReportType_Button.Click
        Title_Label.Text = "Edit Report Type"
        EditReportType_Button.Visible = False
        DeleteReportType_Button.Visible = False
        SaveReportTypeUpdate_Button.Visible = True
        ConfirmReportTypeDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a report type name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteReportType_Button_Click(sender As Object, e As EventArgs) Handles DeleteReportType_Button.Click
        Title_Label.Text = "Permanently Delete Report Type"
        EditReportType_Button.Visible = False
        DeleteReportType_Button.Visible = False
        SaveReportTypeUpdate_Button.Visible = False
        ConfirmReportTypeDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this report type"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM ReportTypes WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The report type name you have entered is already taken. Please choose a different report type name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid report type name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM ReportTypes WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveReportTypeUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveReportTypeUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE ReportTypes SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmReportTypeDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmReportTypeDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Report Type"
        EditReportType_Button.Visible = False
        DeleteReportType_Button.Visible = False
        SaveReportTypeUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM ReportTypes WHERE ID = @ID", Connection)
