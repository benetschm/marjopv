...
Partial Class Administration_ReportSource
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Report Source"
                    EditReportSource_Button.Visible = True
                    DeleteReportSource_Button.Visible = False
                    SaveReportSourceUpdate_Button.Visible = False
                    ConfirmReportSourceDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM ReportSources WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditReportSource_Button.Visible = False
                    DeleteReportSource_Button.Visible = False
                    SaveReportSourceUpdate_Button.Visible = False
                    ConfirmReportSourceDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/ReportSource.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditReportSource_Button_Click(sender As Object, e As EventArgs) Handles EditReportSource_Button.Click
        Title_Label.Text = "Edit Report Source"
        EditReportSource_Button.Visible = False
        DeleteReportSource_Button.Visible = False
        SaveReportSourceUpdate_Button.Visible = True
        ConfirmReportSourceDeletion_Button.Visible = False
    ...
    Protected Sub DeleteReportSource_Button_Click(sender As Object, e As EventArgs) Handles DeleteReportSource_Button.Click
        Title_Label.Text = "Permanently Delete Report Source"
        EditReportSource_Button.Visible = False
        DeleteReportSource_Button.Visible = False
        SaveReportSourceUpdate_Button.Visible = False
        ConfirmReportSourceDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this report source"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM ReportSources WHERE ID <> @ID", Connection)
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM ReportSources WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveReportSourceUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveReportSourceUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE ReportSources SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmReportSourceDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmReportSourceDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Report Source"
        EditReportSource_Button.Visible = False
        SaveReportSourceUpdate_Button.Visible = False
        ConfirmReportSourceDeletion_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM ReportSources WHERE ID = @ID", Connection)
