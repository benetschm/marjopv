<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateRole.aspx.vb" Inherits="Administration_CreateRole" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewRole_Button" runat="server" class="btn btn-primary" Text="Save New Role"></asp:button>
