<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateSeriousnessCriterion.aspx.vb" Inherits="Administration_CreateSeriousnessCriterion" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewSeriousnessCriterion_Button" runat="server" class="btn btn-primary" Text="Save New Seriousness Criterion"></asp:button>
