<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="RechallengeResult.aspx.vb" Inherits="Administration_RechallengeResult" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditRechallengeResult_Button" runat="server" class="btn btn-primary" Text="Edit Rechallenge Result"></asp:button>
                <asp:button ID="DeleteRechallengeResult_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Rechallenge Result"></asp:button>
                <asp:button ID="SaveRechallengeResultUpdate_Button" runat="server" class="btn btn-primary" Text="Save Rechallenge Result Updates"></asp:button>
                <asp:button ID="ConfirmRechallengeResultDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Rechallenge Result Deletion"></asp:button>
