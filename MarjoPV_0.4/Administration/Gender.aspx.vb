...
Partial Class Administration_Gender
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Gender"
                    EditGender_Button.Visible = True
                    DeleteGender_Button.Visible = False
                    SaveGenderUpdate_Button.Visible = False
                    ConfirmGenderDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM Genders WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditGender_Button.Visible = False
                    DeleteGender_Button.Visible = False
                    SaveGenderUpdate_Button.Visible = False
                    ConfirmGenderDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/Gender.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditGender_Button_Click(sender As Object, e As EventArgs) Handles EditGender_Button.Click
        Title_Label.Text = "Edit Gender"
        EditGender_Button.Visible = False
        DeleteGender_Button.Visible = False
        SaveGenderUpdate_Button.Visible = True
        ConfirmGenderDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a gender name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteGender_Button_Click(sender As Object, e As EventArgs) Handles DeleteGender_Button.Click
        Title_Label.Text = "Permanently Delete Gender"
        EditGender_Button.Visible = False
        DeleteGender_Button.Visible = False
        SaveGenderUpdate_Button.Visible = False
        ConfirmGenderDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this gender"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        'Check if entered gender name is already taken and fail validation if not
        Dim Command As New SqlCommand("SELECT Name FROM Genders WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The gender name you have entered is already taken. Please choose a different gender name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        End While
        Connection.Close()
        'Check if gender name was entered and fail validation if not
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid gender name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM Genders WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveGenderUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveGenderUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE Genders SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmGenderDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmGenderDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Gender"
        EditGender_Button.Visible = False
        SaveGenderUpdate_Button.Visible = False
        ConfirmGenderDeletion_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM Genders WHERE ID = @ID", Connection)
