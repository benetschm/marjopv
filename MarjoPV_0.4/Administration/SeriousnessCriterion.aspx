<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="SeriousnessCriterion.aspx.vb" Inherits="Administration_SeriousnessCriterion" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditSeriousnessCriterion_Button" runat="server" class="btn btn-primary" Text="Edit Seriousness Criterion"></asp:button>
                <asp:button ID="DeleteSeriousnessCriterion_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Seriousness Criterion"></asp:button>
                <asp:button ID="SaveSeriousnessCriterionUpdate_Button" runat="server" class="btn btn-primary" Text="Save Seriousness Criterion Updates"></asp:button>
                <asp:button ID="ConfirmSeriousnessCriterionDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Seriousness Criterion Deletion"></asp:button>
