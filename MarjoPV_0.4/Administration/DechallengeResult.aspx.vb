...
Partial Class Administration_DechallengeResult
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Dechallenge Result"
                    EditDechallengeResult_Button.Visible = True
                    DeleteDechallengeResult_Button.Visible = False
                    SaveDechallengeResultUpdate_Button.Visible = False
                    ConfirmDechallengeResultDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM DechallengeResults WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditDechallengeResult_Button.Visible = False
                    DeleteDechallengeResult_Button.Visible = False
                    SaveDechallengeResultUpdate_Button.Visible = False
                    ConfirmDechallengeResultDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/DechallengeResult.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditDechallengeResult_Button_Click(sender As Object, e As EventArgs) Handles EditDechallengeResult_Button.Click
        Title_Label.Text = "Edit Dechallenge Result"
        EditDechallengeResult_Button.Visible = False
        DeleteDechallengeResult_Button.Visible = False
        SaveDechallengeResultUpdate_Button.Visible = True
        ConfirmDechallengeResultDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a dechallenge result name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteDechallengeResult_Button_Click(sender As Object, e As EventArgs) Handles DeleteDechallengeResult_Button.Click
        Title_Label.Text = "Permanently Delete Dechallenge Result"
        EditDechallengeResult_Button.Visible = False
        DeleteDechallengeResult_Button.Visible = False
        SaveDechallengeResultUpdate_Button.Visible = False
        ConfirmDechallengeResultDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this dechallenge result"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        'Check if entered dechallenge result name is already taken and fail validation if not
        Dim Command As New SqlCommand("SELECT Name FROM DechallengeResults WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The dechallenge result name you have entered is already taken. Please choose a different dechallenge result name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        End While
        Connection.Close()
        'Check if dechallenge result name was entered and fail validation if not
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid dechallenge result name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM DechallengeResults WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveDechallengeResultUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveDechallengeResultUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE DechallengeResults SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmDechallengeResultDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmDechallengeResultDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Dechallenge Result"
        EditDechallengeResult_Button.Visible = False
        DeleteDechallengeResult_Button.Visible = False
        SaveDechallengeResultUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM DechallengeResults WHERE ID = @ID", Connection)
