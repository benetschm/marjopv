<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateDrugAction.aspx.vb" Inherits="Administration_CreateDrugAction" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewDrugAction_Button" runat="server" class="btn btn-primary" Text="Save New Drug Action"></asp:button>
