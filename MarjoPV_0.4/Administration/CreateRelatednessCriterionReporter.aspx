<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateRelatednessCriterionReporter.aspx.vb" Inherits="Administration_CreateRelatednessCriterionReporter" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewRelatednessCriterionReporter_Button" runat="server" class="btn btn-primary" Text="Save New Relatedness Criterion Reprter"></asp:button>
