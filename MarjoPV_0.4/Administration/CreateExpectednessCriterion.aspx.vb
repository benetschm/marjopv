...
Partial Class Administration_CreateExpectednessCriterion
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "Create New Expectedness Criterion"
                    SaveNewExpectednessCriterion_Button.Visible = True
                ...
                Else
                    ...
                    SaveNewExpectednessCriterion_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/CreateExpectednessCriterion.aspx")
            End If
        End If
    End Sub
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM ExpectednessCriteria", Connection)
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM ExpectednessCriteria", Connection)
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveNewExpectednessCriterion_Button_Click(sender As Object, e As EventArgs) Handles SaveNewExpectednessCriterion_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim Command As New SqlCommand("INSERT INTO ExpectednessCriteria(Name, SortOrder, Active) VALUES(@Name, @SortOrder, @Active)", Connection)
