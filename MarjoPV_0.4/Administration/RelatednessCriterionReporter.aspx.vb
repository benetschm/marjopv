...
Partial Class Administration_RelatednessCriterionReporter
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Relatedness Criterion Reporter"
                    EditRelatednessCriterionReporter_Button.Visible = True
                    DeleteRelatednessCriterionReporter_Button.Visible = False
                    SaveRelatednessCriterionReporterUpdate_Button.Visible = False
                    ConfirmRelatednessCriterionReporterDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM RelatednessCriteriaReporter WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditRelatednessCriterionReporter_Button.Visible = False
                    DeleteRelatednessCriterionReporter_Button.Visible = False
                    SaveRelatednessCriterionReporterUpdate_Button.Visible = False
                    ConfirmRelatednessCriterionReporterDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/RelatednessCriterionReporter.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditRelatednessCriterionReporter_Button_Click(sender As Object, e As EventArgs) Handles EditRelatednessCriterionReporter_Button.Click
        Title_Label.Text = "Edit Relatedness Criterion Reporter"
        EditRelatednessCriterionReporter_Button.Visible = False
        DeleteRelatednessCriterionReporter_Button.Visible = False
        SaveRelatednessCriterionReporterUpdate_Button.Visible = True
        ConfirmRelatednessCriterionReporterDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a relatedness criterion reporter name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteRelatednessCriterionReporter_Button_Click(sender As Object, e As EventArgs) Handles DeleteRelatednessCriterionReporter_Button.Click
        Title_Label.Text = "Permanently Delete Relatedness Criterion Reporter"
        EditRelatednessCriterionReporter_Button.Visible = False
        DeleteRelatednessCriterionReporter_Button.Visible = False
        SaveRelatednessCriterionReporterUpdate_Button.Visible = False
        ConfirmRelatednessCriterionReporterDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this relatedness criterion reporter"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT Name FROM RelatednessCriteriaReporter WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The relatedness criterion reporter name you have entered is already taken. Please choose a different relatedness criterion reporter name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid relatedness criterion reporter name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM RelatednessCriteriaReporter WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveRelatednessCriterionReporterUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveRelatednessCriterionReporterUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE RelatednessCriteriaReporter SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmRelatednessCriterionReporterDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmRelatednessCriterionReporterDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Relatedness Criterion Reporter"
        EditRelatednessCriterionReporter_Button.Visible = False
        DeleteRelatednessCriterionReporter_Button.Visible = False
        SaveRelatednessCriterionReporterUpdate_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM RelatednessCriteriaReporter WHERE ID = @ID", Connection)
