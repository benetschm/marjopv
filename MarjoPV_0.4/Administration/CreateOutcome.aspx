<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateOutcome.aspx.vb" Inherits="Administration_CreateOutcome" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="SaveNewOutcome_Button" runat="server" class="btn btn-primary" Text="Save New Outcome"></asp:button>
