...
Partial Class Administration_MedicationType
        ...
        If Page.IsPostBack = False Then
            If Login_Status = True Then
                If Logged_In_User_Admin = True Then
                    Title_Label.Text = "View Medication Type"
                    EditMedicationType_Button.Visible = True
                    DeleteMedicationType_Button.Visible = False
                    SaveMedicationTypeUpdate_Button.Visible = False
                    ConfirmMedicationTypeDeletion_Button.Visible = False
                    ...
                    Dim ReadCommand As New SqlCommand("SELECT Name, SortOrder, Active FROM MedicationTypes WHERE ID = @ID", Connection)
                ...
                Else
                    ...
                    EditMedicationType_Button.Visible = False
                    DeleteMedicationType_Button.Visible = False
                    SaveMedicationTypeUpdate_Button.Visible = False
                    ConfirmMedicationTypeDeletion_Button.Visible = False
                    Cancel_Button.Visible = False
                ...
                End If
            Else
                Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Administration/MedicationType.aspx?ID=" & Request.QueryString("ID"))
            End If
        End If
    End Sub

    Protected Sub EditMedicationType_Button_Click(sender As Object, e As EventArgs) Handles EditMedicationType_Button.Click
        Title_Label.Text = "Edit Medication Type"
        EditMedicationType_Button.Visible = False
        DeleteMedicationType_Button.Visible = False
        SaveMedicationTypeUpdate_Button.Visible = True
        ConfirmMedicationTypeDeletion_Button.Visible = False
        ...
        Name_Textbox.ToolTip = "Please enter a medication type name"
        Name_Textbox.CssClass = "form-control"
        SortOrder_Row.Visible = True
    ...
    Protected Sub DeleteMedicationType_Button_Click(sender As Object, e As EventArgs) Handles DeleteMedicationType_Button.Click
        Title_Label.Text = "Permanently Delete Medication Type"
        EditMedicationType_Button.Visible = False
        DeleteMedicationType_Button.Visible = False
        SaveMedicationTypeUpdate_Button.Visible = False
        ConfirmMedicationTypeDeletion_Button.Visible = False
        ...
        Status_Label.Text = "Confirming will permanently delete this medication type"
        Name_Row.Visible = True
        Name_Textbox.ReadOnly = True
        Name_Textbox.ToolTip = String.Empty
        Name_Textbox.CssClass = "form-control"
    ...
    Protected Sub Name_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        'Check if entered medication type name is already taken and fail validation if not
        Dim Command As New SqlCommand("SELECT Name FROM MedicationTypes WHERE ID <> @ID", Connection)
        ...
        While Reader.Read()
            ...
            If Db_Name = Name_Textbox.Text Then
                ...
                Name_Textbox.ToolTip = "The medication type name you have entered is already taken. Please choose a different medication type name"
                Connection.Close()
                args.IsValid = False
                Exit Sub
            End If
        End While
        Connection.Close()
        'Check if medication type name was entered and fail validation if not
        ...
        Else
            Name_Textbox.CssClass = "form-control alert-danger"
            Name_Textbox.ToolTip = "Please make sure you are entering a valid medication type name"
            args.IsValid = False
        End If
    End Sub
    ...
    Protected Sub SortOrder_Textbox_Validator_ServerValidate(source As Object, args As ServerValidateEventArgs)
        ...
        Dim Command As New SqlCommand("SELECT SortOrder FROM MedicationTypes WHERE ID <> @ID", Connection)
        Command.Parameters.AddWithValue("@ID", Request.QueryString("ID"))
        Dim Reader As SqlDataReader
        Connection.Open()
        Reader = Command.ExecuteReader()
    ...
    Protected Sub SaveMedicationTypeUpdate_Button_Click(sender As Object, e As EventArgs) Handles SaveMedicationTypeUpdate_Button.Click
        If Page.IsValid = True Then
            ...
            Active_DropDownList.ToolTip = String.Empty
            Active_DropDownList.CssClass = "form-control alert-success"
            Dim UpdateCommand As New SqlCommand("UPDATE MedicationTypes SET Name = @Name, SortOrder = @SortOrder, Active = @Active WHERE ID = @ID", Connection)
    ...
    Protected Sub ConfirmMedicationTypeDeletion_Button_Click(sender As Object, e As EventArgs) Handles ConfirmMedicationTypeDeletion_Button.Click
        Title_Label.Text = "Permanently Delete Medication Type"
        EditMedicationType_Button.Visible = False
        SaveMedicationTypeUpdate_Button.Visible = False
        ConfirmMedicationTypeDeletion_Button.Visible = False
        ...
        Active_Row.Visible = False
        Dim DeleteCommand As New SqlCommand("DELETE FROM MedicationTypes WHERE ID = @ID", Connection)
