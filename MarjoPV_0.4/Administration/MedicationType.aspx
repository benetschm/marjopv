<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="MedicationType.aspx.vb" Inherits="Administration_MedicationType" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditMedicationType_Button" runat="server" class="btn btn-primary" Text="Edit Medication Type"></asp:button>
                <asp:button ID="DeleteMedicationType_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Medication Type"></asp:button>
                <asp:button ID="SaveMedicationTypeUpdate_Button" runat="server" class="btn btn-primary" Text="Save Medication Type Updates"></asp:button>
                <asp:button ID="ConfirmMedicationTypeDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Medication Type Deletion"></asp:button>
