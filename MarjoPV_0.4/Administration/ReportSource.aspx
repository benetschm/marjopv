<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="ReportSource.aspx.vb" Inherits="Administration_ReportSource" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel btn-group">
                <asp:button ID="EditReportSource_Button" runat="server" class="btn btn-primary" Text="Edit Report Source"></asp:button>
                <asp:button ID="DeleteReportSource_Button" runat="server" class="btn btn-primary" Text="Permanently Delete Report Source"></asp:button>
                <asp:button ID="SaveReportSourceUpdate_Button" runat="server" class="btn btn-primary" Text="Save Report Source Updates"></asp:button>
                <asp:button ID="ConfirmReportSourceDeletion_Button" runat="server" class="btn btn-primary" Text="Confirm Report Source Deletion"></asp:button>
