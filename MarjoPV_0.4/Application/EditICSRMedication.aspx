<%@ Page Title="Edit ICSR Medication" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="EditICSRMedication.aspx.vb" Inherits="Application_EditICSRMedication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <table class="table table-responsive table-striped table-hover">
                        ...
                        <tr ID="MedicationRole_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_MedicationPerICSRRole_ID_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="MedicationName_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_Medication_ID_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="TotalDailyDose_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_TotalDailyDose_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="Allocations_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_Allocations_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="Start_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_Start_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="Stop_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_Stop_HiddenField" runat="server" />
                            </td>
                        </tr>
                        <tr ID="DrugAction_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_DrugAction_ID_HiddenField" runat="server" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
    ...
    <asp:HiddenField ID="ICSRMedicationID_HiddenField" runat="server" />
