<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateMedication.aspx.vb" Inherits="Application_CreateMedication" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="ButtonGroup_Div" class="panel btn-group" runat="server">
                <asp:button ID="ConfirmMedicationInput_Button" runat="server" class="btn btn-primary" Text="Confirm New Medication Details"></asp:button>
                <asp:button ID="SaveUpdates_Button" runat="server" class="btn btn-primary" Text="Save New Medication"></asp:button>
