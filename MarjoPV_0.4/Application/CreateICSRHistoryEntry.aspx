<%@ Page Title="Add ICSR History Entry" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateICSRHistoryEntry.aspx.vb" Inherits="Application_CreateICSRHistoryEntry" %>
            ...
            <asp:UpdatePanel id="Main_Table" runat="server">
                <ContentTemplate>
                    <table class="table table-responsive table-striped table-hover">
                        ...
                        <tr ID="ICSRHistoryEntry_Row" runat="server">
                            <td>ICSR History Entry:</td>
                            <td>
                                <asp:Textbox ID="ICSRHistoryEntry_Textbox" runat="server" CssClass="form-control" ></asp:Textbox>
                                <asp:CustomValidator ID="ICSRHistoryEntry_Textbox_Validator" runat="server" OnServerValidate="ICSRHistoryEntry_Textbox_Validator_ServerValidate"></asp:CustomValidator>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
