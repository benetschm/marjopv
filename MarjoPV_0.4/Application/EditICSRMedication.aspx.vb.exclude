...
Partial Class Application_EditICSRMedication
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            If Not (Request.QueryString("ICSRMedicationID") Is Nothing) Then
                'Store querystring vlaues in hidden fields
            ...
            ElseIf Not (Request.QueryString("ICSRID") Is Nothing) Then
                'Store querystring values in hidden fields
                ...
                If Login_Status = True Then
                    ...
                    End If
                Else  'Redirect user to login if he/she is not logged in
                    Response.Redirect("~/Login.aspx?ReturnUrl=" & VirtualPathUtility.ToAbsolute("~/") & "Application/EditICSRMedication.aspx?ICSRID=" & CurrentICSR_ID)
                End If
            Else
    ...
    Protected Sub SaveUpdates_Button_Click(sender As Object, e As EventArgs) Handles SaveUpdates_Button.Click, ConfirmDeletion_Button.Click
        If Page.IsValid = True Then
            ...
            If Not (Request.QueryString("ICSRID") Is Nothing) Then 'If dataset is being created
            ...
            ElseIf Not (Request.QueryString("ICSRMedicationID") Is Nothing) Then 'if dataset is being updated
                Dim CurrentICSRMedication_ID As Integer = ICSRMedicationID_HiddenField.Value
