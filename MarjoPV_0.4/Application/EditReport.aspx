<%@ Page Title="Edit Report" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="EditReport.aspx.vb" Inherits="Application_EditReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <table class="table table-responsive table-striped table-hover">
                        ...
                        <tr ID="ReportType_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReportType_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReportStatus_Row" runat="server">
                            <td>Report Status:</td>
                            <td>
                                <asp:DropDownList ID="ReportStatus_DropDownList" runat="server" CssClass="form-control"></asp:DropDownList>
                                <asp:CustomValidator ID="ReportStatus_Validator" runat="server" OnServerValidate="ReportStatus_DropDownList_Validator_ServerValidate"></asp:CustomValidator>
                                <asp:HiddenField ID="AtEditPageLoad_ReportStatus_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReportReceived_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReportReceived_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReportDue_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReportDue_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReportComplexity_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReportComplexity_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReportSource_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReportSource_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReporterName_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReporterName_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReporterAddress_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="ReporterAddress_Textbox_Validator" runat="server" OnServerValidate="ReporterAddress_Textbox_Validator_ServerValidate"></asp:CustomValidator>
                                 <asp:HiddenField ID="AtEditPageLoad_ReporterAddress_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReporterPhone_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReporterPhone_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReporterFax_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ReporterFax_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ReporterEmail_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="ReporterEmail_Textbox_Validator" runat="server" OnServerValidate="ReporterEmail_Textbox_Validator_ServerValidate"></asp:CustomValidator>
                                   <asp:HiddenField ID="AtEditPageLoad_ReporterEmail_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ExpeditedReportingRequired_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ExpeditedReportingRequired_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ExpeditedReportingDone_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:HiddenField ID="AtEditPageLoad_ExpeditedReportingDone_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                        <tr ID="ExpeditedReportingDate_Row" runat="server">
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="ExpeditedReportingDate_Textbox_Validator" runat="server" OnServerValidate="ExpeditedReportingConsistency_Validator_ServerValidate"></asp:CustomValidator>
                                <asp:HiddenField ID="AtEditPageLoad_ExpeditedReportingDate_HiddenField" runat="server"></asp:HiddenField>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
    ...
    <asp:HiddenField ID="ReportID_HiddenField" runat="server" />
