<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="AttachFile.aspx.vb" Inherits="Application_AttachFile" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="ButtonGroup_Div" class="panel btn-group" runat="server">
                ...
                <asp:button ID="ReturnToOverview_Button" runat="server" class="btn btn-primary"></asp:button>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <ContentTemplate>
                    <table class="table table-responsive table-striped table-hover">
                        ...
                        <tr>
                            <td>File:</td>
                            <td>
                                <asp:FileUpload ID="AttachedFileUpload" runat="server" CssClass="form-control"/>
                                <asp:CustomValidator ID="AttachedFileUpload_Validator" runat="server" OnServerValidate="AttachedFileUpload_Validator_ServerValidate" ></asp:CustomValidator>
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
