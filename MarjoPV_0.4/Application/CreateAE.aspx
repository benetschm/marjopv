<%@ Page Title="Create AE" Language="VB" MasterPageFile="~/MasterPages/SiteMaster.master" AutoEventWireup="false" CodeFile="CreateAE.aspx.vb" Inherits="Application_CreateAE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="ButtonGroup_Div" class="panel btn-group" runat="server">
                <asp:button ID="SaveUpdates_Button" runat="server" class="btn btn-primary" Text="Save New AE"></asp:button>
                ...
                <ContentTemplate>
                    <table class="table table-responsive table-striped table-hover">
                        ...
                        <tr>
                            <td>Start Date:</td>
                            <td>
                                <asp:TextBox ID="Start_Textbox" runat="server"
 CssClass="form-control"></asp:TextBox>
                        ...
                        <tr>
                            <td>Stop Date:</td>
                            <td>
                                <asp:TextBox ID="Stop_Textbox" runat="server"
 CssClass="form-control"></asp:TextBox>
