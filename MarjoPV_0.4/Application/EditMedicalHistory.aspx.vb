...
Partial Class Application_EditMedicalHistory
    ...
    Protected Sub SaveUpdates_Button_Click(sender As Object, e As EventArgs) Handles SaveUpdates_Button.Click, ConfirmDeletion_Button.Click
        If Page.IsValid = True Then
            ...
            '    EntryString += HistoryEntryPlainValue("Medical Hsitory Entry", CurrentMedicalHistory_ID, "MedDRA LLT", AtSaveButtonClick_MedDRATerm, Updated_MedDRATerm)
            'End If
            'If Updated_Start <> AtSaveButtonClick_Start Then
            '    EntryString += HistoryEntryPlainValue("Medical History Entry", CurrentMedicalHistory_ID, "Start Date", AtSaveButtonClick_Start, Updated_Start)
            'End If
            'If Updated_Stop <> AtSaveButtonClick_Stop Then
            '    EntryString += HistoryEntryPlainValue("Medical History Entry", CurrentMedicalHistory_ID, "Stop Date", AtSaveButtonClick_Stop, Updated_Stop)
            'End If
